...
class listsNcounts extends StatefulWidget {
  @override
  State<listsNcounts> createState() => _listsNcounts();
}

class _listsNcounts extends State<listsNcounts> {
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
          title: "Lists and Counts",
          onClickedHome: () {
